...
namespace Super_ForeverAloneInThaDungeon
{
    ...
    partial class Game
    {
        ...
        Room generateRoom(Point p, Point size, byte dir, bool doorAtP = true, bool placeMatters = true)
        {
            ...
            if (doorAtP)
            {
                //tiles[p.X, p.Y] = new Door(dir > 1);
                tiles[p.X, p.Y] = new Tile(TileType.Corridor);
            }
        ...
        static Point GetRandomPointInRoom(Room r)
        {
        ...
        /// <summary>
        /// Generates the points needed to make a corridor at a given point, direction and length.
        /// </summary>
        /// <returns>The corridor or null if impossible</returns>
